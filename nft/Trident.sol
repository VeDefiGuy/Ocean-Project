...
contract Trident is ERC721Enumerable, Ownable {
    ...
    // mint price
    uint256 public MINT_PRICE = 100 ether;

    // genesis mint price
    uint256 public GENESIS_MINT_PRICE = 50 ether;
    ...
    function claimRefReward() external {
        ...
        referrers[_msgSender()].lastClaimTime = block.timestamp;
    ...
    function setMaxPerAddress(uint256 _value) public onlyOwner {
        MAX_PER_ADDRESS = _value;
    }
